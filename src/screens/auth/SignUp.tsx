...
import { Center, Button, Text, FormControl } from 'native-base';
...
const SignUp = ({ navigation, route }: Props) => {
  ...
  const handleSubmit = async () => {
    try {
      await dispatch(register(formik.values as RegisterRequestType));
        ...
        <FormControl>
          <PhoneInput
            ...
            onChangeText={(text: string) => {
              formik.setFieldValue('phone.number', text);
            }}
            onChangeFormattedText={(text: string) => {
              formik.setFieldValue('phone.country', text);
            }}
          />
